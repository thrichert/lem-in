...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/03/22 12:50:45 by apopinea          #+#    #+#             */
/*   Updated: 2017/03/22 12:50:46 by apopinea         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	ft_print_p_b_moins(t_ft_printf_env *e)
{
	ft_set_char_verif('0', e);
	ft_set_char_verif('x', e);
...
**		par les flag
**	ft_print_p_b_mois -> ft_printf/ft_print_p.c
**		print si attribut -
**	ft_print_p_b_zero -> ft_printf/ft_print_p_2.c
**		print si attribut 0
**	ft_print_p_b_else -> ft_printf/ft_print_p_2.c
